...
export default function GeneratorPage() {
  ...
  const category = siteConfig.toolCategories.find(cat => cat.id === 'generator')
  const tools = siteConfig.tools.filter(tool => tool.category === 'generator')

  const content = {
    ko: {
      title: '생성도구',
      description: '코드, 텍스트, 이미지를 생성하는 유용한 도구들',
      allTools: '모든 도구',
      home: '홈',
      tools: '도구',
      useBtn: '사용하기',
    ...
    en: {
      ...
      description: 'Useful tools for generating code, text, and images',
      allTools: 'All Tools',
      home: 'Home',
      tools: 'Tools',
      useBtn: 'Use Tool',
