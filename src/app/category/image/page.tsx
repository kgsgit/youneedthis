...
export default function ImagePage() {
  ...
  const category = siteConfig.toolCategories.find(cat => cat.id === 'image')
  const tools = siteConfig.tools.filter(tool => tool.category === 'image')

  const content = {
    ko: {
      title: '이미지도구',
      description: '이미지 편집, 변환, 생성을 위한 도구들',
      allTools: '모든 도구',
      home: '홈',
      tools: '도구',
      useBtn: '사용하기',
    ...
    en: {
      title: 'Image Tools',
      description: 'Tools for image editing, conversion, and generation',
      allTools: 'All Tools',
      home: 'Home',
      tools: 'Tools',
      useBtn: 'Use Tool',
