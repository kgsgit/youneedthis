...
export default function ValidatorPage() {
  ...
  const category = siteConfig.toolCategories.find(cat => cat.id === 'validator')
  const tools = siteConfig.tools.filter(tool => tool.category === 'validator')

  const content = {
    ko: {
      title: '검증도구',
      description: '데이터와 코드의 유효성을 검증하는 도구들',
      allTools: '모든 도구',
      home: '홈',
      tools: '도구',
      useBtn: '사용하기',
    ...
    en: {
      ...
      description: 'Tools for validating data and code',
      allTools: 'All Tools',
      home: 'Home',
      tools: 'Tools',
      useBtn: 'Use Tool',
