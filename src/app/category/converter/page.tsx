...
export default function ConverterPage() {
  ...
  const category = siteConfig.toolCategories.find(cat => cat.id === 'converter')
  const tools = siteConfig.tools.filter(tool => tool.category === 'converter')

  const content = {
    ko: {
      title: '변환도구',
      description: '파일, 단위, 형식을 변환하는 유용한 도구들',
      allTools: '모든 도구',
      home: '홈',
      tools: '도구',
      useBtn: '사용하기',
    ...
    en: {
      ...
      description: 'Useful tools for converting files, units, and formats',
      allTools: 'All Tools',
      home: 'Home',
      tools: 'Tools',
      useBtn: 'Use Tool',
